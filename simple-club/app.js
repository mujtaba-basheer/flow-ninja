    ...
    S3.upload(
      {
        ...
        Body: fs.createReadStream(`simple-club/dist/${file}.js`),
        ACL: "public-read",
...
for (const file of filesToUpload) {
  (async () => {
    const inputCode = fs.readFileSync(`simple-club/${file}.js`, {
      encoding: "utf8",
    });
    const outputCode = minify(inputCode, {}).code;
    fs.writeFileSync(`simple-club/dist/${file}.min.js`, outputCode, {
      encoding: "utf8",
    });
