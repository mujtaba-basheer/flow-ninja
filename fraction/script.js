...
const original_value = 1000000;
const loan_amt = 100000;
...
results.cash_pocket.regular_mortgage = -PV(constants.DISCOUNT_RATE / 12, term * 12, payment, mortgages[term * 12].balance);
...
results.net_cost.regular_mortgage =
    Math.pow((mortgages[term * 12].balance + payment * term * 12) / loan_amt, 1 / term) - 1;
