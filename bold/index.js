    ...
    // Matter-js
    {
        ...
        const setup = () => {
            ...
            const onMounted = () => {
                ...
                // WALL ADD x,y,w,h
                const wallTop = Bodies.rectangle(matterRect.matterW / 2, 0 - 490, matterRect.matterW, 1000, {
                    isStatic: true,
                    label: "roof",
                ...
                Events.on(mouseConstraint, "mousedown", function (event) {
                    if (!hitTest) {
                        ...
                        mouseConstraint.mouse.element.removeEventListener("touchstart", 
                        // @ts-ignore
                        mouseConstraint.mouse.mousedown);
                        mouseConstraint.mouse.element.removeEventListener("touchend", 
                        // @ts-ignore
                ...
                Events.on(mouseConstraint, "mouseup", function (event) {
                    ...
                    if (!hitTest) {
                        ...
                        // @ts-ignore
                        mouseConstraint.mouse.mousemove);
                        mouseConstraint.mouse.element.addEventListener("touchstart", 
                        // @ts-ignore
                        mouseConstraint.mouse.mousedown);
